    ...
    <div class="cours">
        <div class="cours__header">
            <div class="cours__block">
                <img :src="`src/assets/image/${cours.iconSrc}`" :alt="cours.title" class="cours__image">
            ...
            <div class="cours__prices">
                ...
                <div class="cours__block--column">
                    <Rating :rating="cours.rating" :isActive="false" class="cours__rating" />
        ...
        <div class="cours__main">
            <p>{{ cours.body }}</p>

            <div class="cours__details">
                <div class="cours__block--column">
                    <ul>
                        <li v-for="option in cours.info" :key="option.name" class="cours__info-item">
                ...
                <div class="cours__block--columns">
                    <div v-for="option in cours.features" :key="option.name" class="cours__features" :class="{
